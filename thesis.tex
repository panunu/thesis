...
Halusimme selvittää, onko puheenvuorojen eroavaisuuksien seuraaminen hyödyllistä, tai voiko sen visualisoimalla hahmottaa jotakin uutta keskusteluun liittyen. Pystymmekö esimerkiksi erottelemaan keskustelijat, joilla on tuoda uusia ideoita puheenaiheiksi heistä, jotka vain toistelevat edellämainittuja aiheita. Eroavaisuuksista voimme myös mahdollisesti nähdä, eteneekö keskustelu eri aihepiireihin.

Työssä tutkittiin kahta erilaista lähestymistapaa:
\begin{enumerate}
\item Puheenvuoron eroavaisuus verrattuna edelliseen puheenvuoroon
\item Yksittäisen puheenvuoron eroavaisuus kokonaisuuteen.
\end{enumerate}

Erilaisuus määritetään Jakkard-indeksillä, jota käytetään dokumenttien samanlaisuuden ja erilaisuuden vertailuun.
